...
const char*	SecurityFileManager::file_name_userInfo_dat			= "/data/data/com.honda.connmc/userInfo.dat";
const char*	SecurityFileManager::file_name_userInfo_secInfo		= "/data/data/com.honda.connmc/userInfo.secInfo";
const char*	SecurityFileManager::file_name_vehicleInfo_dat		= "/data/data/com.honda.connmc/vehicleInfo.dat";
const char*	SecurityFileManager::file_name_vehicleInfo_secInfo	= "/data/data/com.honda.connmc/vehicleInfo.secInfo";
