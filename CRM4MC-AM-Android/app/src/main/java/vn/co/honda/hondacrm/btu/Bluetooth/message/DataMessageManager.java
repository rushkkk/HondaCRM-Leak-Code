package vn.co.honda.hondacrm.btu.Bluetooth.message;
...
import vn.co.honda.hondacrm.btu.Utils.MessageUtils;
    ...
    private boolean splitMsgAndSend(byte[] data) {
        synchronized (LOCK_DATA_CTRL) {
            ...
            if (offset == data.length) {
                ...
                // Send config SAB FLAG OFF
                VehicleMessageSabFlag vehicleMessageSabFlag = new VehicleMessageSabFlag(VehicleMessageSabFlag.SAB_FLAG_OFF);
