...
public class BookingServiceStepTwoAdapter  extends RecyclerView.Adapter<BookingServiceStepTwoAdapter.ViewHolder> {
    ...
    public BookingServiceStepTwoAdapter(Context context, List<Dealers> mDataList, OnClick onClick, boolean typeList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.lnItemDealer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onClick.onClickDealerThreeItem(dealer);
            }
        });
        ...
        holder.btnBookingService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onClick.onClickSelectDealer(dealer);
            }
        });
    ...
    public interface OnClick {
        ...
        void onClickDealerThreeItem(Dealers dealer);

        void onClickSelectDealer(Dealers dealers);
    }
}