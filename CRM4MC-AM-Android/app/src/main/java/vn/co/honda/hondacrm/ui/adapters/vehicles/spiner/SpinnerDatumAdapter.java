package vn.co.honda.hondacrm.ui.adapters.vehicles.spiner;
...
public class SpinnerDatumAdapter extends ArrayAdapter<Datum> {

    private final LayoutInflater mInflater;
    private final Context mContext;
    private final List<Datum> items;

    public SpinnerDatumAdapter(@NonNull Context context, @NonNull List objects) {
