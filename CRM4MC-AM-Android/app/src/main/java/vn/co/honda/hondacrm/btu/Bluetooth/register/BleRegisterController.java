...
import vn.co.honda.hondacrm.btu.Constants.register.VehicleRegistrationStatus;
import vn.co.honda.hondacrm.btu.Constants.register.VehicleRegistrationType;
import vn.co.honda.hondacrm.btu.Interfaces.listener.register.IF_VehicleRegisterListener;
import vn.co.honda.hondacrm.btu.Interfaces.method.register.IF_Register_Methods;
import vn.co.honda.hondacrm.btu.Model.message.VehicleMessageStatusInquiry;
...
import vn.co.honda.hondacrm.btu.Model.message.register.request.VehicleMessageRegistrationRequest;
import vn.co.honda.hondacrm.btu.Model.message.register.response.RegistrationStatusIndicationMessage;
import vn.co.honda.hondacrm.btu.Model.message.register.response.VehicleMessageSecurityConfigResponse;
import vn.co.honda.hondacrm.btu.Model.message.register.response.VehicleSecurityConfigMessage;
...
import static vn.co.honda.hondacrm.btu.Constants.register.VehicleRegistrationType.VEHICLE_REGISTRATION_TYPE_REGISTER;
