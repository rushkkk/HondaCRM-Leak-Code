...
public class SpinnerVehicleAdapter extends ArrayAdapter<Vehicle> {
    ...
    public SpinnerVehicleAdapter(@NonNull Context context, @NonNull List objects) {
    ...
    private View createItemView(int position, View convertView, ViewGroup parent) {
        ...
        Vehicle offerData = items.get(position);

        offTypeTv.setText(offerData.getVehicleName());
