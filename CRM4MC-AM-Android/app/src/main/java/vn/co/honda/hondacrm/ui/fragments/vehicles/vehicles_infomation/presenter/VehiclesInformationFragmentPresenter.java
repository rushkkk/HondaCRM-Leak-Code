 ...
 * @author CuongNV31
 */
public class VehiclesInformationFragmentPresenter extends BasePresenter<INewsFragmentView>
        implements IVehiclesInformationFragmentPresenter {

    private final INewsFragmentInteractor mNewsFragmentInteractor;
    private INewsFragmentView mNewsFragmentView;

    public VehiclesInformationFragmentPresenter(INewsFragmentInteractor newsInteractor) {
