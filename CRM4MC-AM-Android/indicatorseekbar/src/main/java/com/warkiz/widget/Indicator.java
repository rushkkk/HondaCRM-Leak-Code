                ...
                if (progressTextViewId > 0) {
                    ...
                    if (view != null) {
                        if (view instanceof TextView) {
                            ...
                            mProgressTextView.setText(mSeekBar.getIndicatorTextString().first);
...
//            }
    ...
    private GradientDrawable getGradientDrawable() {
        ...
        if (mSeekBar.getIndicatorTextString().second == 1) {
...
//        } else
    ...
    void updateIndicatorLocation(int offset) {
        setMargin(mIndicatorView, offset, -1, 1, 3);
    }

    void updateArrowViewLocation(int offset) {
        setMargin(mArrowView, offset, -1, 1, 3);
    }
    ...
    void refreshProgressText() {
        String tickTextString = mSeekBar.getIndicatorTextString().first;
//        if (mIndicatorView instanceof CircleBubbleView) {
...
//        }else
        ...
        if (mProgressTextView != null) {
            mTopContentView.setBackgroundResource(R.color.isb_selector_tick_marks_color);
            mProgressTextView.setText(tickTextString);
            mProgressTextView.setTextColor(Color.BLUE);
        }
    }

    void refreshProgressTextNew() {
        String tickTextString = mSeekBar.getIndicatorTextString().first;
//        if (mIndicatorView instanceof CircleBubbleView) {
//            ((CircleBubbleView) mIndicatorView).setProgress(tickTextString);
//        }else
    ...
    public void setTopContentViewNew(int type) {
        switch (type) {
            case 2:
                if (mTopContentView != null) {
                    // change text color
                    mProgressTextView.setTextColor(Color.parseColor("#FFFFFF"));
                    mTopContentView.setBackgroundResource(R.drawable.boder_tv_seekbar_done);
                    mArrowView.setColor(Color.parseColor("#ED1B2F"));
            ...
            case 1:
                if (mTopContentView != null) {
                    // change text color
                    mProgressTextView.setTextColor(Color.parseColor("#000000"));
                    mTopContentView.setBackgroundResource(R.drawable.boder_tv_seekbar);
                    mArrowView.setColor(Color.parseColor("#ffffff"));
                }
            default:
    ...
    @NonNull
    private GradientDrawable getGradientDrawableNew() {
        GradientDrawable tvDrawable;
//        if (mSeekBar.getIndicatorTextString().second == 1) {
        tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(R.drawable.boder_tv_seekbar_done);
//        } else {
//            tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(R.drawable.isb_indicator_square_corners);
//        }
        tvDrawable.setColor(mIndicatorColor);
