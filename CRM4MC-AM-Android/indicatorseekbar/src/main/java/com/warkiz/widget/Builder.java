...
//    int showTickMarksType = TickMarkType.NONE;
    ...
    /**
     * user change the thumb_img's location by touching thumb_img,touching track will not worked.
     *
     * @param onlyThumbDraggable true for seeking only by drag thumb_img. default false;
     * @return Builder
     */
    ...
    /**
     * set the seek bar's thumb_img's text color.
     *
    ...
    /**
     * call this method to show the text below thumb_img or not
     *
     * @param showThumbText show the text below thumb_img or not
     * @return Builder
     */
    ...
    /**
     * set the seek bar's thumb_img's selector color.
     *
    ...
    //<item android:color="@color/colorAccent" android:state_pressed="true" />  <!--this color is for thumb_img which is at pressing status-->
    //<item android:color="@color/color_blue" />                                <!--for thumb_img which is at normal status-->
    //</selector>
    ...
    /**
     * set the seek bar's thumb_img's Width.will be limited in 30dp.
     *
     ...
     *
     * @param thumbDrawable the drawable for thumb_img.
     * @return Builder
     */
    ...
    /**
     * call this method to custom the thumb_img showing drawable by selector Drawable.
     *
    ...
    //<?xml version="1.0" encoding="utf-8"?>
    //<selector xmlns:android="http://schemas.android.com/apk/res/android">
    //<item android:drawable="Your drawableA" android:state_pressed="true" />  <!--this drawable is for thumb_img when pressing-->
    //<item android:drawable="Your drawableB" />  < !--for thumb_img when normal-->
    //</selector>
    ...
    //<?xml version="1.0" encoding="utf-8"?>
    //<selector xmlns:android="http://schemas.android.com/apk/res/android">
    //<item android:color="@color/colorAccent" android:state_selected="true" />  <!--this color is for texts those are at left side of thumb_img-->
    //<item android:color="@color/color_blue" android:state_hovered="true" />     <!--for thumb_img below text-->
    //<item android:color="@color/color_gray" />                                 <!--for texts those are at right side of thumb_img-->
    //</selector>
    ...
    /**
     * set the tick text's / thumb_img text textTypeface .
     *
