 ...
 * touch track or thumb_img as well as changes that were initiated programmatically.
 */
public interface OnSeekChangeListener {
     ...
     * clients can use the thumbPosition parameter to check the thumb_img position on ticks and
     * tick text parameter to get the tick text which located at current thumb_img below.
     *
